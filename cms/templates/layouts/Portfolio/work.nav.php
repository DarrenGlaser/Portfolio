        ...
        <div class="container-fluid position-relative g-lg-4 ml-3 mr-3">
            ...
            <div class="col col-lg-8 navbar-accordion">
                ...
                <div id="header-nav" class="collapse navbar-collapse justify-content-center">
                    <ul class="navbar-nav">
                        <li class="nav-item"><a class="" href="https://darrenglaser.co.uk">Home</a></li>
                        <li class="nav-item"><a class="" href="https://darrenglaser.co.uk#about">About</a></li>
                        <li class="nav-item"><a class="" href="https://darrenglaser.co.uk#experience">What I Do</a></li>
                        <li class="nav-item"><a class="" href="https://darrenglaser.co.uk#resume">Resume</a></li>
                        <li class="nav-item"><a class="" href="https://darrenglaser.co.uk#portfolio">Portfolio</a></li>
                        <li class="nav-item"><a class="" href="https://darrenglaser.co.uk#testimonial">Client</a></li>
                        <li class="nav-item"><a class="" href="https://darrenglaser.co.uk/work">All Work</a></li>
