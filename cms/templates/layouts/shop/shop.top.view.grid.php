...
<a id="btn_list" class="button button-list" title="List" href="<?php echo $newURL . '&lyO=list' ?>">&nbsp;</a>
<a id="btn_grid" class="button button-grid <?php echo $btnActive ?>" title="Grid" href="<?php echo $newURL . '&lyO=grid' ?>">&nbsp;</a>
