...
<section id="home">
    <div class="hero-wrap">
        ...
        <!--
        <div class="hero-bg parallax" style="background-image:url('/noindex/imgs/images/darren_001.jpg');"></div>
        <div class="hero-content section d-flex min-vh-100">
            <div class="container my-auto">
                <div class="row">
                    <div class="col-12 text-center">
                        <div class="typed-strings">
                            <p>I'm Darren Glaser</p>
                            <p>a full stack developer</p>
                            <p>looking for employment</p>
                        ...
                        <p class="text-5 text-light mb-4">based in Cheshire, UK.</p>
                        <a href="#contact" class="btn btn-outline-primary rounded-pill shadow-none smooth-scroll mt-2">Employ Me</a>
                    </div>
                </div>
            </div>
